...
class Settings(BaseSettings):
    ...
    # -- Stress testing -------------------------------------------------------
    # Where the simulator's own HTTP control API lives. The test runner talks
    # to it directly (the same API the dashboard's Simulator page already
    # uses) so a test run creates genuine chargers with real WebSocket
    # connections, not a synthetic stand-in.
    simulator_base_url: str = "http://localhost:9100"
